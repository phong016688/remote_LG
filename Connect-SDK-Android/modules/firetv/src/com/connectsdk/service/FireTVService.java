...
public class FireTVService extends DeviceService implements MediaPlayer, MediaControl {
    ...
    public FireTVService(ServiceDescription serviceDescription, ServiceConfig serviceConfig) {
        ...
        Log.d("Connect SDK ", "connect fire FireTVService getServiceUUID: "+ serviceConfig.getServiceUUID() );
        Log.d("Connect SDK ", "connect fire FireTVService getDevice: "+ serviceDescription.getDevice() );
        Log.d("Connect SDK ", "connect fire FireTVService toJSONObject: "+ serviceDescription.toJSONObject() );
    ...
    public static DiscoveryFilter discoveryFilter() {
        Log.d("Connect SDK ", "connect fire discoveryFilter: ");
        return new DiscoveryFilter(ID, "_amzn-wplay._tcp.local.");
    }
    ...
    @Override
    public void connect() {
        Log.d("Connect SDK ", "connect fire connect: ");
        super.connect();
    ...
    public boolean isConnected() {
        Log.d("Connect SDK ", "connect fire isConnected: ");
        return connected;
    }
    ...
    public boolean isConnectable() {
        Log.d("Connect SDK ", "connect fire isConnectable: ");
        return true;
    }
    ...
    public void disconnect() {
        super.disconnect();
        Log.d("Connect SDK ", "connect fire disconnect: ");
    ...
    protected void updateCapabilities() {
        Log.d("Connect SDK ", "connect fire updateCapabilities: ");
    ...
    public CapabilityPriorityLevel getPriorityLevel(Class<? extends CapabilityMethods> clazz) {
        Log.d("Connect SDK ", "connect fire getPriorityLevel ");
        if (clazz != null) {
    ...
    public MediaPlayer getMediaPlayer() {
        Log.d("Connect SDK ", "connect fire getMediaPlayer: ");
        return this;
    }
    ...
    public CapabilityPriorityLevel getMediaPlayerCapabilityLevel() {
        Log.d("Connect SDK ", "connect fire getMediaPlayerCapabilityLevel: ");
    ...
    public void getMediaInfo(final MediaInfoListener listener) {
        Log.d("Connect SDK ", "connect fire getMediaInfo: ");
    ...
    public ServiceSubscription<MediaInfoListener> subscribeMediaInfo(MediaInfoListener listener) {
        Log.d("Connect SDK ", "connect fire subscribeMediaInfo: ");
    ...
    public void displayImage(String url, String mimeType, String title, String description,
        ...
        Log.d("AppTag###", "displayImage2: " + url);
    ...
    public void playMedia(String url, String mimeType, String title, String description,
        ...
        Log.d("Connect SDK ", "connect fire playMedia: ");
        setMediaSource(new MediaInfo.Builder(url, mimeType)
                .setTitle(title)
                .setDescription(description)
                .setIcon(iconSrc)
    ...
    public void closeMedia(LaunchSession launchSession, final ResponseListener<Object> listener) {
        Log.d("Connect SDK ", "connect fire closeMedia: ");
        stop(listener);
    }
    ...
    public void displayImage(MediaInfo mediaInfo, LaunchListener listener) {
        Log.d("AppTag###", "displayImage1: " + mediaInfo.getDescription());
    ...
    public CapabilityPriorityLevel getMediaControlCapabilityLevel() {
        Log.d("Connect SDK ", "connect fire getMediaControlCapabilityLevel: ");
        return CapabilityPriorityLevel.HIGH;
    }
    ...
    public void play(ResponseListener<Object> listener) {
        Log.d("Connect SDK ", "connect fire play: ");
    ...
    public void pause(ResponseListener<Object> listener) {
        Log.d("Connect SDK ", "connect fire pause: ");
    ...
    public void stop(ResponseListener<Object> listener) {
        Log.d("Connect SDK ", "connect fire stop: ");
    ...
    public void rewind(ResponseListener<Object> listener) {
        Log.d("Connect SDK ", "connect fire rewind: ");
        Util.postError(listener, ServiceCommandError.notSupported());
    }
    ...
    public void fastForward(ResponseListener<Object> listener) {
        Log.d("Connect SDK ", "connect fire fastForward: ");
        Util.postError(listener, ServiceCommandError.notSupported());
    }
    ...
    public void previous(ResponseListener<Object> listener) {
        Log.d("Connect SDK ", "connect fire previous: ");
        Util.postError(listener, ServiceCommandError.notSupported());
    }
    ...
    public void next(ResponseListener<Object> listener) {
        Log.d("Connect SDK ", "connect fire next: ");
        Util.postError(listener, ServiceCommandError.notSupported());
    }
    ...
    public void seek(long position, ResponseListener<Object> listener) {
        Log.d("Connect SDK ", "connect fire seek: ");
    ...
    public void getDuration(final DurationListener listener) {
        Log.d("Connect SDK ", "connect fire getDuration: ");
